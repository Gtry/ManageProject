export default {
  ...
  info: {
    title: 'auth-admin',
    list: [
      'auth-admin-template 是一个基于VueJS的工程可视化管理平台，采用token交互验证方式。',
      '您可以 auth-admin-template 为基础，不只限制于vue的页面，你可以嵌入任意第三方网站，基于iframe框架。',
      'auth-admin-template 构建简单上手快，最大程度上帮助企业节省时间成本和费用开支。'
    ]
  },
  wel: {
    title: 'auth-admin-template 通用管理系统快速开发框架',
    list: [
